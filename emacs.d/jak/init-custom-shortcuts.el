(use-package general
  ...
  (jak/leader-keys
    ...
    "h/"  '(helm-projectile-ag :which-key "ag, silver search")
    ...
    ;; "off"  '(jak/org-roam-node-find-permanent :which-key "Find from all nodes")
    "off"  '(org-roam-node-find :which-key "Find from all nodes")
    "ofe"  '(org-roam-node-find :which-key "Find from all nodes/everything")
    "ofa"  '(jak/org-roam-node-find-areas :which-key "Find from all area nodes")
    "ofd"  '(jak/org-roam-node-find-permanents :which-key "Find from all permanent nodes")
    "ofm"  '(jak/org-roam-node-find-meetings :which-key "Find from all meeting nodes")
    "ofp"  '(jak/org-roam-node-find-projects :which-key "Find from all project nodes")
    "ofh"  '(jak/org-roam-node-find-persons :which-key "Find from all person nodes")
    "ofc"  '(jak/org-roam-node-find-persons :which-key "Find from all person nodes")
    "ofo"  '(jak/org-roam-node-find-organizations :which-key "Find from all organization nodes")
    "ofw"  '(jak/org-roam-node-find-bookmarks :which-key "Find from all web nodes")
    "ofb"  '(jak/org-roam-node-find-bookmarks :which-key "Find from all web nodes")
    ...
    "orfm"  '(jak/org-roam-node-find-meetings :which-key "Find from all meeting nodes")
    "orfp"  '(jak/org-roam-node-find-projects :which-key "Find from all project nodes")
    "orfh"  '(jak/org-roam-node-find-persons :which-key "Find from all person nodes")
    "orfc"  '(jak/org-roam-node-find-persons :which-key "Find from all person nodes")
    "orfo"  '(jak/org-roam-node-find-organizations :which-key "Find from all organization nodes")
    "orfw"  '(jak/org-roam-node-find-bookmarks :which-key "Find from all web nodes")
    "orfb"  '(jak/org-roam-node-find-bookmarks :which-key "Find from all web nodes")
