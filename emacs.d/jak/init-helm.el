...
(global-set-key (kbd "C-c C-i") 'helm-swoop)
;;(global-set-key (kbd "C-I") 'helm-swoop-back-to-last-point)
...
;;
(global-set-key (kbd "C-c C-/") 'helm-find)

;;(global-set-key (kbd "C-x C-c C-b") 'helm-resume)
